#!/usr/bin/env python3
"""
Compress purity.jpg from Desktop and save to public/generators/
"""
...
# Paths
SOURCE = os.path.expanduser("~/Desktop/purity.jpg")
TARGET_DIR = "public/generators"
TARGET_FILE = os.path.join(TARGET_DIR, "purity.jpg")
TARGET_SIZE_KB = 200

def compress_purity():
    """Compress purity.jpg from Desktop"""
...
def main():
    print("=" * 60)
    print("  Compress purity.jpg - Target: <200KB")
    print("=" * 60)

    if compress_purity():
        print("\n✅ Success! purity.jpg has been compressed and saved.")
    else:
        print("\n❌ Failed to compress purity.jpg")

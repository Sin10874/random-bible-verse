    ...
    <>
      ...
      <div>
        ...
        <ol className="mt-3 sm:mt-4 list-decimal list-inside space-y-2 sm:space-y-2.5 text-sm sm:text-base text-white/90 leading-relaxed">
          <li>Click the &ldquo;Random Bible Verse&rdquo; button above to get a random Scripture passage</li>
      ...
      additionalSections: [
        {
          ...
          content: "Hebrews 6:19 describes hope as &ldquo;an anchor for the soul, firm and secure.&rdquo; In life&apos;s storms, biblical hope keeps us grounded and stable. Unlike wishful thinking, Christian hope is confident expectation based on God&apos;s character and promises. This hope doesn&apos;t disappoint because it&apos;s rooted in the unchanging nature of God and secured by the resurrection of Jesus Christ."
        },
        {
          title: "Living Hope Through Christ",
          content: "1 Peter 1:3 speaks of the &ldquo;living hope&rdquo; we have through the resurrection of Jesus Christ from the dead. This hope is alive and active, not a dead religious concept. Because Jesus conquered death, we have hope for eternal life, hope for transformation, and hope that sustains us through every trial. This living hope changes how we face each day."
        }
      ]
    },
    strength: {
      ...
      additionalSections: [
        ...
        },
        {
          ...
          content: "&ldquo;I can do all things through Christ who strengthens me&rdquo; (Philippians 4:13) is one of the most beloved verses about strength. This doesn&apos;t mean we can accomplish anything we dream up, but rather that Christ gives us strength to handle whatever circumstances God allows in our lives. Whether facing abundance or need, health or sickness, success or failure, Christ&apos;s strength is sufficient for every situation."
        }
      ]
    },
    peace: {
      ...
      additionalSections: [
        ...
        },
        {
          ...
          content: "Isaiah 9:6 prophesies that the Messiah would be called the &ldquo;Prince of Peace.&rdquo; Jesus is the source of true peace. In John 14:27, He says, &ldquo;Peace I leave with you; my peace I give you. I do not give to you as the world gives.&rdquo; The world&apos;s peace depends on favorable circumstances, but Christ&apos;s peace is rooted in His victory over sin and death. Through relationship with Him, we access this lasting peace."
        }
      ]
    },
    faith: {
